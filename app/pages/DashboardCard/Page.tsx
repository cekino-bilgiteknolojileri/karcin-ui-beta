...
import { HeaderTab, DashboardCard } from 'karcin-ui';
...
const DashboardCardPage = (props) => {
	...
	return(
		<div className="wrapper">
			...
			<div className="componentH1">DashboardCard</div>
			<p className="normalP mt10 mb20" dangerouslySetInnerHTML={{ __html: getLangText('dashboardCardMetin') }} />
...
const KarcinTable = () => {
	...
	const [table, setTable] = useState([
		{ propertyName: 'title', required: required(), type: 'string', description: getLangText('propsTitle') },
		{ propertyName: 'subTitle', required: required(), type: 'string | number', description: getLangText('propsSubTitle') },
		{ propertyName: 'icon', required: required(), type: 'React.ReactNode', description: getLangText('propsIcon') },
		{ propertyName: 'color', required: required(), type: 'string', description: getLangText('propsColor') }
	]);
